...
def create_app(config_object='config.Config'):
    ...
    from app.utils.formatters import date_ar, datetime_ar, month_ar, year_ar, num_ar, money_ar, money_ar_2, to_argentina, num_ar
    ...
    app.jinja_env.filters['to_argentina'] = to_argentina
    app.jinja_env.filters["num_ar"] = num_ar
